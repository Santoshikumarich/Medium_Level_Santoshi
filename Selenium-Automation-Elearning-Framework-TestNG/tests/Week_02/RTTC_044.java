package Week_02;
	...
	public class RTTC_044 extends RTTC_043  {
		...
		public void validLoginTest() throws InterruptedException, AWTException {
		    ...
		    //clicking on Fingerring product name
		    ProductPOM.Fingerring();
			System.out.println("7.Finger ring product is checked");
			screenShot.captureScreenShot("Finger ring  page");
		    Thread.sleep(3000);		    
